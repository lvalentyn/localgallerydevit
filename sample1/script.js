        ...
        for (let image of imagesList) {
            ...
            <div class="col-md-3 mt-3">
                <div class="card img-card">
                    <img src="${image}"
                        alt="" class="img-fluid card-img">
                    <div class="card-body">
                        <h3 class="card-title">Image</h3>
                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus tempore
                            inventore, perferendis quaerat quis consequatur assumenda. Pariatur ad totam a?</p>
                    </div>
                </div>
            </div>`;
        }
